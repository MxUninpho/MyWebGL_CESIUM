...
var originCarto = Cartographic.fromDegrees(114,25,0);
...
var ellipsoid = new Ellipsoid(50000, 50000, 50000);
...
var czml = [{
    ...
    "model": {
        ...
        "distanceDisplayCondition":{ 
            "distanceDisplayCondition":{"DistanceDisplayCondition":[10,1000]}
        }
...
var dataSourcePromise = viewer.dataSources.add(CzmlDataSource.load(czml));
